...
\begin{document}
	...
	\textsc{Tímto pravidlem se \underline{nikdy} nesmíte řídit.} Příliš časté zvýrazňování textových elementů a~změny velikosti {\tiny písma} jsou {\LARGE známkou} {\textbf{{\huge a\-ma\-té\-ris\-mu}} autora a~působí \textit{\textbf{velmi} rušivě.} Dobře na\-vr\-že\-ný dokument nemá obsahovat více než 4 řezy či druhy písma. \texttt{Dobře na\-vr\-že\-ný dokument je decentní, ne chaotický.}
